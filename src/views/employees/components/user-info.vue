      ...
      <el-row class="inline-info">
        <el-col :span="12">
          <el-form-item label="员工头像">
            <!-- 放置上传图片 -->
            <Uploadimg ref="staffPhoto" @onSuccess="staffPhotoSuccess" />
          </el-form-item>
        </el-col>
      </el-row>
      <!-- 保存个人信息 -->
...
import { getPersonalDetail, updatePersonal, saveUserDetailById, getEmployeeSimple, updateJob, getJobDetail } from '@/api/employees'
